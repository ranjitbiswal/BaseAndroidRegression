...
static void verifySuccessfulPaymentUsingCreditCardTestCase()
{
	...
	if (lPaymentOptionsCount.size() > 0) {
		...
		for (int index2 = randomnumber; index2 <= lPaymentOptionsCount.size(); ) {
			...
			Mobile.tap(findTestObject('SCM Mobile/Billing/Utility Bill/Next Button'), 3, 
        FailureHandling.CONTINUE_ON_FAILURE)
...
static void verifyAutoPayTestCases() {
	...
	applicationMethods.ReusableMethods.isMobileElementDisplayed('SCM Mobile/Billing/Auto Pay/Select Credit Card Heading','Select Credit Card Heading')
	...
	applicationMethods.ReusableMethods.isMobileElementDisplayed('SCM Mobile/Billing/Auto Pay/Select Bank Account Heading','Select Bank Account Heading')
	
	'Scroll to View Bill'
	Mobile.scrollToText('I Agree To Terms & Conditions', FailureHandling.CONTINUE_ON_FAILURE)

	applicationMethods.ReusableMethods.isMobileElementDisplayed('SCM Mobile/Billing/Auto Pay/I Agree To Terms and Conditions CheckBox','I Agree To Terms and Conditions CheckBox ')
	...
	'TC --> TC_BLG_65 -->To verify Auto Pay Menu Page Objects'
