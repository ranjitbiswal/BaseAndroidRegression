...
static void verifyNotificationPreferencesTestCases() {
	...
	'TC :TC_SD_1 TC_SD_19  TC_MANP_1, TC_MANP_2 To verify that Notification Preferences Tab and page objects'
	...
	3, FailureHandling.CONTINUE_ON_FAILURE) == false) {
		...
		for (int index1 = randomnumber; index1 < lNotificationPreferences.size(); ) {
			...
			3, FailureHandling.CONTINUE_ON_FAILURE) == true) {
				...
				'TC_MANP_5 Verify and Clicking on I Agree Button'
	...
	'BHarti'
	Mobile.tap(findTestObject('SCM Mobile/Hamburger Menu/Notification Preferences/Notification Preferences Billing Menu'), 5)

	'TC_MANP_16 TC_MANP_24'
	messageText = Mobile.getAttribute(findTestObject('SCM Mobile/Hamburger Menu/Notification Preferences/CheckBoxTextField'), 'checked', 1, FailureHandling.CONTINUE_ON_FAILURE)
	...
	String messageText1 = Mobile.getAttribute(findTestObject('SCM Mobile/Hamburger Menu/Notification Preferences/TextFieldTextBox'), 'text',
			5, FailureHandling.CONTINUE_ON_FAILURE)
	if (messageText1.equals("994944999"))
	{
		println "Text is same as Pre defined value while registration."
	}
	else
	{
		println "Text is some thing unexpected, check Manually"
	}

	''
	messageText = Mobile.getAttribute(findTestObject('SCM Mobile/Hamburger Menu/Notification Preferences/CheckBoxEmailField'), 'checked', 1, FailureHandling.CONTINUE_ON_FAILURE)

	if (messageText.equals("false")){
		println('Notification Text Medium is not selected, so we are selecting this medium')

		'Clicking on Check Box'
		Mobile.tap(findTestObject('SCM Mobile/Hamburger Menu/Notification Preferences/CheckBoxEmailField'),
				3, FailureHandling.CONTINUE_ON_FAILURE)
	}
	String messageText1 = Mobile.getAttribute(findTestObject('SCM Mobile/Hamburger Menu/Notification Preferences/EmailAddressTextBox'), 'text',
			5, FailureHandling.CONTINUE_ON_FAILURE)
	if (messageText1.equals("sahil.dheer2@smartusys.com"))
	{
		println "Email Address is same as Pre defined value while registration."
	}
	else
	{
		println "Email Address is some thing unexpected, check Manually"
	}

	''
	messageText = Mobile.getAttribute(findTestObject('SCM Mobile/Hamburger Menu/Notification Preferences/CheckBoxIVRField'), 'checked', 1, FailureHandling.CONTINUE_ON_FAILURE)

	if (messageText.equals("false")){
		println('Notification IVR Medium is not selected, so we are selecting this medium')

		'Clicking on Check Box'
		Mobile.tap(findTestObject('SCM Mobile/Hamburger Menu/Notification Preferences/CheckBoxIVRField'),
				3, FailureHandling.CONTINUE_ON_FAILURE)
	}
	String messageText1 = Mobile.getAttribute(findTestObject('SCM Mobile/Hamburger Menu/Notification Preferences/VoiceCallTextBox'), 'text',
			5, FailureHandling.CONTINUE_ON_FAILURE)
	if (messageText1.equals("999-999-9999"))
	{
		println "IVR is same as Pre defined value while registration."
	}
	else
	{
		println "IVR is some thing unexpected, check Manually"
	}
